    ...
    var body: some View {
        NavigationView {
            List {
                ...
                //print viewModel properties for debugging in console
                .onAppear {
                    print("Profile Info: \(viewModel.age), \(viewModel.sex.rawValue), \(viewModel.insulin ? "Yes" : "No"), \(viewModel.history ? "Yes" : "No"), \(viewModel.kidneyDisease ? "Yes" : "No"), \(viewModel.diabetesType.rawValue), \(viewModel.mealPreference.rawValue), \(viewModel.consentDataUse ? "Yes" : "No"), \(viewModel.receiveAdvice ? "Yes" : "No")")
                }
